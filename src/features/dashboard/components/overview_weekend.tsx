...
export function WeekendDashboard() {
  return (
    <div className='space-y-4'>
      <div className='grid gap-4 sm:grid-cols-1 lg:grid-cols-5'>
        <Card className='rounded-xl border bg-gradient-to-b from-white to-[#f1a87c]/20 shadow-sm'>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>+222,615</div>
            <p className='text-xs text-muted-foreground'>+474.16% since 2007</p>
          </CardContent>
        </Card>
        <Card className='rounded-xl border bg-gradient-to-b from-white to-[#82a1d3]/20 shadow-sm'>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>+51,673</div>
            <p className='text-xs text-muted-foreground'>+15.33% since 2005</p>
          </CardContent>
        </Card>
        <Card className='rounded-xl border bg-gradient-to-b from-white to-[#9fca86]/20 shadow-sm'>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground'>-13.01% since 2005</p>
          </CardContent>
        </Card>
        ...
        <Card className='rounded-xl border bg-gradient-to-b from-white to-[#fed466]/20 shadow-sm'>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>+302,512</div>
            <p className='text-xs text-muted-foreground'>+5.73% since 2005</p>
          </CardContent>
        </Card>
      </div>
      <div className='grid grid-cols-1 gap-4 lg:grid-cols-7'>
        <Card className='col-span-1 lg:col-span-4'>
          ...
          <CardContent className='ps-2'>
            {/* <Overview dataUrl='http://localhost:5000/api/dashboard/overview/trip_dis_gro_rate/94/113/weekend' /> */}
            <Overview dataUrl='data/trip_dis_gro_rate_weekend.json' />
          </CardContent>
        </Card>
        <Card className='col-span-1 lg:col-span-3'>
          ...
          <CardContent>
            {/* <TripRanking dataUrl='http://localhost:5000/api/dashboard/overview/trip_count/113/weekend' /> */}
            <TripRanking dataUrl='data/trip_count_113_weekend.json' />
          </CardContent>
        </Card>
      </div>
    </div>
